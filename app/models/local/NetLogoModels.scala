...
object NetLogoModels {
  ...
  type ModelType = (String, WorldDimensions)

  def termites: ModelType = {
    val modelText =
      """
        ...
        |end
      """.trim.stripMargin
    (modelText, WorldDimensions(-25, 25, -25, 25))
  }

  def climate: ModelType = {
    val modelText =
      """
        |globals [
        ...
        |end
      """.trim.stripMargin
    (modelText, WorldDimensions(-20, 20, -20, 20))
  }
