wolfSpaceDefault = {
  ...
  defs: { version: 6, blocks: [
    { "action": "\uD83D\uDC3A wolf actions ", "limit": 1, "format": "to wolf-actions", "isRequired": true, "placement": NetTango.blockPlacementOptions.STARTER },
    { "action": "wolf meets sheep ", "limit": 1, "format": "to wolf-meets-sheep", "isRequired": true, "placement": NetTango.blockPlacementOptions.STARTER },
    ...
    { "action": "\uD83D\uDC11 ask nearby sheep", "format": "ask sheep in-radius 3", "clauses": [{ "blocks": [] }] },
    { "action": "chance", "format": "if random 100 < {0}", "clauses": [{ "blocks": [] }], "params": [ { "type": "range", "min": 0, "max": 100, "step": 0.5, "default": 20, "unit": "%", "name": "percent" } ] } ] }
...
sheepSpaceDefault = {
  name: "Sheep",
  # coffeelint: disable=max_line_length
  defs: { version: 6, blocks: [ { "action": "\uD83D\uDC11 sheep actions ", "limit": 1, "format": "to sheep-actions", "isRequired": true, "placement": NetTango.blockPlacementOptions.STARTER },
  { "action": "forward", "format": "forward {0}", "params": [ { "type": "range", "min": 0, "max": 3, "step": 0.1, "default": 1, "name": "steps" } ] },
  { "action": "wiggle", "format": "left ({0} - random (2 * {0}))", "params": [ { "type": "range", "min": 0, "max": 90, "step": 1, "default": 50, "random": true, "name": "amount", "unit": "\u00B0" } ] },
  { "action": "hatch", "format": "hatch 1 [ rt random-float 360 fd 1 ]" }, { "action": "die" },
  { "action": "chance", "format": "if random 100 < {0}", "clauses": [{ "blocks": [] }], "params": [ { "type": "range", "min": 0, "max": 100, "step": 0.5, "default": 20, "unit": "%", "name": "percent" } ] } ] }
