...
[
  ...
  __hnw_supervisor_mouse-x
  __hnw_supervisor_mouse-y
...
to startup
  ...
  set __hnw_supervisor_mouse-x 0
  set __hnw_supervisor_mouse-y 0
...
to handle-mouse-move [mouse-x mouse-y]
  set __hnw_supervisor_mouse-x mouse-x
  set __hnw_supervisor_mouse-y mouse-y
end
...
to-report mouse-coords
  report (word "(" ( precision ((__hnw_supervisor_mouse-x - y-axis) * grids-per-patch-x) 1)
         "," ( precision ((__hnw_supervisor_mouse-y - x-axis) * grids-per-patch-y ) 1 ) ")")
end
