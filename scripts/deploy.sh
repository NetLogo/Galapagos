...
# Usage (from root of the Galapgos repo): ./scripts/deploy.sh s3-target-bucket/target-folder DISTRIBUTION_ID
# Example: ./scripts/deploy.sh netlogo-web-experiments-content/nettango E2TDYOH5TZH83M
